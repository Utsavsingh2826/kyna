...
async function seedDeliveredOrders() {
  try {
    ...
    const { OrderModel } = await import('./src/models/orderModel.js');
    const { TrackingOrder } = await import('./src/models/TrackingOrder.js');
