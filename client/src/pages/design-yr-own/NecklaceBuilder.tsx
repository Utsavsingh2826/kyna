  ...
  const renderStep1 = () => (
    <div className="max-w-6xl mx-auto">
      <StickyTwoColumnLayout
        ...
        rightColumn={
          <div className="space-y-6">
            {/* Necklace Image Display */}
            <div className="rounded-lg p-8 flex items-center justify-center min-h-64">
              <img
                src="/navigation/upload-your-design/necklacedisplay.jpg"
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                "We want to make sure your necklace is exactly how you envision
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="14">14 inches (Choker)</SelectItem>
                  <SelectItem value="16">16 inches (Collar)</SelectItem>
                  <SelectItem value="18">18 inches (Princess)</SelectItem>
                  <SelectItem value="20">20 inches (Matinee)</SelectItem>
                  <SelectItem value="24">24 inches (Opera)</SelectItem>
                  <SelectItem value="30">30 inches (Rope)</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="box">Box Clasp</SelectItem>
                  <SelectItem value="ball">Ball Clasp</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            >
              <div className="bg-[#328F94]/5 rounded-lg p-4">
                ...
                <p className="text-sm text-[#8D8A91] mb-3">
                  ...
                  appear on the side of the necklace on the inside.
                </p>
              </div>
            </Link>
          </div>
