...
export default function RingBuilder() {
  ...
  const [selectedEngravingImage, setSelectedEngravingImage] = useState("");
  ...
  const validateForStep = (targetStep: number): boolean => {
    ...
    if (targetStep === 3) {
      ...
      if (formData.diamondColor === "Center Stone") {
        toast.error(
