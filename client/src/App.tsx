...
import RingBuilder from "./pages/design-yr-own/RingBuilder";
import PendantBuilder from "./pages/design-yr-own/PendantDisplay";
import BangleBuilder from "./pages/design-yr-own/BangelBuilder";
import BraceletBuilder from "./pages/design-yr-own/BraceletBuilder";
import NecklaceBuilder from "./pages/design-yr-own/NecklaceBuilder";
import EarringBuilder from "./pages/design-yr-own/EarringBuilder";
